...
from BOTs.Bet_Sizing.base_functions import get_signal, avg_active_signals, discrete_signal, get_w, get_target_pos, \
    limit_price, bet_size
from BOTs.Bet_Sizing.ef3m import raw_moment, M2N, most_likely_parameters
...
def bet_size_dynamic(current_pos, max_pos, market_price, forecast_price, cal_divergence=10, cal_bet_size=0.95,
    ...
    events_0['t_pos'] = events_0['t_pos'] / abs(events_0['t_pos'])

    print(events_0['t_pos'])
